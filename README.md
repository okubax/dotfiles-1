...
5. Terminal [colorschemes](/Xresources.d/colors), [bitmap](/Xresources.d/title.xbm) used for the wallpaper, and the [script](/Xresources.d/random-color-picker) used to load a random color & wallpaper on each startup is the work of [dkeg](https://github.com/dkeg/crayolo).
