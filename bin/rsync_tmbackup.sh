...
DEST_FOLDER=""
EXCLUSION_FILE=""
LOG_DIR="$HOME/logs/$APPNAME"
AUTO_DELETE_LOG="1"

RSYNC_FLAGS="-D --compress --numeric-ids --links --hard-links --one-file-system --itemize-changes --times --recursive --perms --owner --group --stats --human-readable --delete --delete-excluded"
